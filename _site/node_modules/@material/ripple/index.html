...
<link rel="canonical" href="http://localhost:4000/node_modules/@material/ripple/" />
<meta property="og:url" content="http://localhost:4000/node_modules/@material/ripple/" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/@material/ripple/","headline":"estebang23.github.io","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">class</span> <span class="nx">MyMDCComponent</span> <span class="kd">extends</span> <span class="nx">MDCComponent</span> <span class="p">{</span>
  <span class="kd">constructor</span><span class="p">()</span> <span class="p">{</span>
    <span class="k">super</span><span class="p">(...</span><span class="kr">arguments</span><span class="p">);</span>
    <span class="kd">const</span> <span class="nx">foundation</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">MDCRippleFoundation</span><span class="p">(</span><span class="nb">Object</span><span class="p">.</span><span class="nx">assign</span><span class="p">(</span><span class="nx">MDCRipple</span><span class="p">.</span><span class="nx">createAdapter</span><span class="p">(</span><span class="k">this</span><span class="p">),</span> <span class="p">{</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">class</span> <span class="nx">MyComponent</span> <span class="p">{</span>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code class="highlighter-rouge">util.getMatchesProperty(HTMLElementPrototype) =&gt; Function</code></td>
      <td>Return the correct “matches” property to use on the current browser</td>
    </tr>
    <tr>
