...
<link rel="canonical" href="http://localhost:4000/node_modules/coa/README.ru.html" />
<meta property="og:url" content="http://localhost:4000/node_modules/coa/README.ru.html" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/coa/README.ru.html","headline":"Command-Option-Argument","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">require</span><span class="p">(</span><span class="s1">'coa'</span><span class="p">).</span><span class="nx">Cmd</span><span class="p">()</span> <span class="c1">// декларация команды верхнего уровня</span>
    ...
    <span class="p">.</span><span class="nx">title</span><span class="p">(</span><span class="s1">'Жутко полезная утилита для командной строки'</span><span class="p">)</span> <span class="c1">// название для использования в справке и сообщениях</span>
    ...
    <span class="p">.</span><span class="nx">opt</span><span class="p">()</span> <span class="c1">// добавляем параметр</span>
        <span class="p">.</span><span class="nx">name</span><span class="p">(</span><span class="s1">'version'</span><span class="p">)</span> <span class="c1">// имя параметра для использования в API</span>
        <span class="p">.</span><span class="nx">title</span><span class="p">(</span><span class="s1">'Version'</span><span class="p">)</span> <span class="c1">// текст для вывода в сообщениях</span>
        <span class="p">.</span><span class="kr">short</span><span class="p">(</span><span class="s1">'v'</span><span class="p">)</span> <span class="c1">// короткое имя параметра: -v</span>
        <span class="p">.</span><span class="kr">long</span><span class="p">(</span><span class="s1">'version'</span><span class="p">)</span> <span class="c1">// длинное имя параметра: --version</span>
    ...
    <span class="p">.</span><span class="nx">cmd</span><span class="p">().</span><span class="nx">name</span><span class="p">(</span><span class="s1">'subcommand'</span><span class="p">).</span><span class="nx">apply</span><span class="p">(</span><span class="nx">require</span><span class="p">(</span><span class="s1">'./subcommand'</span><span class="p">).</span><span class="nx">COA</span><span class="p">).</span><span class="nx">end</span><span class="p">()</span> <span class="c1">// загрузка подкоманды из модуля</span>
    <span class="p">.</span><span class="nx">cmd</span><span class="p">()</span> <span class="c1">// добавляем еще одну подкоманду</span>
        <span class="p">.</span><span class="nx">name</span><span class="p">(</span><span class="s1">'othercommand'</span><span class="p">).</span><span class="nx">title</span><span class="p">(</span><span class="s1">'Еще одна полезная подпрограмма'</span><span class="p">).</span><span class="nx">helpful</span><span class="p">()</span>
...
<span class="nx">exports</span><span class="p">.</span><span class="nx">COA</span> <span class="o">=</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span>
    <span class="k">this</span>
        <span class="p">.</span><span class="nx">title</span><span class="p">(</span><span class="s1">'Полезная подпрограмма'</span><span class="p">).</span><span class="nx">helpful</span><span class="p">()</span>
        <span class="p">.</span><span class="nx">opt</span><span class="p">()</span>
