...
<title>encodeurl | estebang23.github.io</title>
<meta name="generator" content="Jekyll v3.7.3" />
<meta property="og:title" content="encodeurl" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/node_modules/encodeurl/" />
<meta property="og:url" content="http://localhost:4000/node_modules/encodeurl/" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/encodeurl/","headline":"encodeurl","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<div class="language-sh highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nv">$ </span>npm install encodeurl
</code></pre></div></div>

<h2 id="api">API</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">encodeUrl</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'encodeurl'</span><span class="p">)</span>
</code></pre></div></div>
...
“%” character unless it is not part of a valid sequence (<code class="highlighter-rouge">%20</code> will be
left as-is, but <code class="highlighter-rouge">%foo</code> will be encoded as <code class="highlighter-rouge">%25foo</code>).</p>
...
<p>This function is <em>similar</em> to the intrinsic function <code class="highlighter-rouge">encodeURI</code>, except it
will not encode the <code class="highlighter-rouge">%</code> character if that is part of a valid sequence, will
not encode <code class="highlighter-rouge">[</code> and <code class="highlighter-rouge">]</code> (for IPv6 hostnames) and will replace raw, unpaired
...
<p><a href="/node_modules/encodeurl/LICENSE">MIT</a></p>
