...
<title>TweetNaCl.js Changelog | estebang23.github.io</title>
<meta name="generator" content="Jekyll v3.7.3" />
<meta property="og:title" content="TweetNaCl.js Changelog" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/node_modules/tweetnacl/CHANGELOG.html" />
<meta property="og:url" content="http://localhost:4000/node_modules/tweetnacl/CHANGELOG.html" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/tweetnacl/CHANGELOG.html","headline":"TweetNaCl.js Changelog","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
functions are no longer available:</p>
    ...
    <div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>nacl.util.decodeUTF8
...
<a href="https://github.com/dchest/tweetnacl-util-js">https://github.com/dchest/tweetnacl-util-js</a> package:</p>
    ...
    <div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>&lt;script src="nacl.min.js"&gt;&lt;/script&gt;
&lt;script src="nacl-util.min.js"&gt;&lt;/script&gt;
</code></pre></div>    </div>

    <p>or</p>

    <div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>var nacl = require('tweetnacl');
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>  nacl.sign(message, secretKey) -&gt; signedMessage
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>  nacl.sign.detached(message, secretKey) -&gt; signature
