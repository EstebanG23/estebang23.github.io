...
<title>combined-stream | estebang23.github.io</title>
<meta name="generator" content="Jekyll v3.7.3" />
<meta property="og:title" content="combined-stream" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/node_modules/combined-stream/" />
<meta property="og:url" content="http://localhost:4000/node_modules/combined-stream/" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/combined-stream/","headline":"combined-stream","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm install combined-stream
</code></pre></div></div>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">CombinedStream</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'combined-stream'</span><span class="p">);</span>
...
they are needed. If you don’t want that to happen, you can set <code class="highlighter-rouge">pauseStreams</code>
to <code class="highlighter-rouge">false</code>:</p>
...
by calling a <code class="highlighter-rouge">next()</code> function:</p>
...
<ul>
  ...
  <li><code class="highlighter-rouge">pauseStreams</code></li>
</ul>

<p>The effect of those options is described below.</p>

<h3 id="combinedstreampausestreams--true">combinedStream.pauseStreams = <code class="highlighter-rouge">true</code></h3>

<p>Whether to apply back pressure to the underlaying streams. If set to <code class="highlighter-rouge">false</code>,
the underlaying streams will never be paused. If set to <code class="highlighter-rouge">true</code>, the
underlaying streams will be paused right after being appended, as well as when
<code class="highlighter-rouge">delayedStream.pipe()</code> wants to throttle.</p>

<h3 id="combinedstreammaxdatasize--2--1024--1024">combinedStream.maxDataSize = <code class="highlighter-rouge">2 * 1024 * 1024</code></h3>

<p>The maximum amount of bytes (or characters) to buffer for all source streams.
If this value is exceeded, <code class="highlighter-rouge">combinedStream</code> emits an <code class="highlighter-rouge">'error'</code> event.</p>

<h3 id="combinedstreamdatasize--0">combinedStream.dataSize = <code class="highlighter-rouge">0</code></h3>

<p>The amount of bytes (or characters) currently buffered by <code class="highlighter-rouge">combinedStream</code>.</p>

<h3 id="combinedstreamappendstream">combinedStream.append(stream)</h3>

<p>Appends the given <code class="highlighter-rouge">stream</code> to the combinedStream object. If <code class="highlighter-rouge">pauseStreams</code> is
set to `true, this stream will also be paused right away.</p>

<p><code class="highlighter-rouge">streams</code> can also be a function that takes one parameter called <code class="highlighter-rouge">next</code>. <code class="highlighter-rouge">next</code>
is a function that must be invoked in order to provide the <code class="highlighter-rouge">next</code> stream, see
example above.</p>

<p>Regardless of how the <code class="highlighter-rouge">stream</code> is appended, combined-stream always attaches an
<code class="highlighter-rouge">'error'</code> listener to it, so you don’t have to do that manually.</p>

<p>Special case: <code class="highlighter-rouge">stream</code> can also be a String or Buffer.</p>

<h3 id="combinedstreamwritedata">combinedStream.write(data)</h3>

<p>You should not call this, <code class="highlighter-rouge">combinedStream</code> takes care of piping the appended
streams into itself for you.</p>

<h3 id="combinedstreamresume">combinedStream.resume()</h3>

<p>Causes <code class="highlighter-rouge">combinedStream</code> to start drain the streams it manages. The function is
idempotent, and also emits a <code class="highlighter-rouge">'resume'</code> event each time which usually goes to
the stream that is currently being drained.</p>

<h3 id="combinedstreampause">combinedStream.pause();</h3>

<p>If <code class="highlighter-rouge">combinedStream.pauseStreams</code> is set to <code class="highlighter-rouge">false</code>, this does nothing.
Otherwise a <code class="highlighter-rouge">'pause'</code> event is emitted, this goes to the stream that is
currently being drained, so you can use it to apply back pressure.</p>

<h3 id="combinedstreamend">combinedStream.end();</h3>

<p>Sets <code class="highlighter-rouge">combinedStream.writable</code> to false, emits an <code class="highlighter-rouge">'end'</code> event, and removes
all streams from the queue.</p>

<h3 id="combinedstreamdestroy">combinedStream.destroy();</h3>

<p>Same as <code class="highlighter-rouge">combinedStream.end()</code>, except it emits a <code class="highlighter-rouge">'close'</code> event instead of
<code class="highlighter-rouge">'end'</code>.</p>
