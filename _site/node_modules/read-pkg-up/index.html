...
<title>read-pkg-up | estebang23.github.io</title>
<meta name="generator" content="Jekyll v3.7.3" />
<meta property="og:title" content="read-pkg-up" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/node_modules/read-pkg-up/" />
<meta property="og:url" content="http://localhost:4000/node_modules/read-pkg-up/" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/read-pkg-up/","headline":"read-pkg-up","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
  ...
  <body>
    <div class="container-lg px-3 my-5 markdown-body">
      ...
      <h1 id="read-pkg-up-">read-pkg-up <a href="https://travis-ci.org/sindresorhus/read-pkg-up"><img src="https://travis-ci.org/sindresorhus/read-pkg-up.svg?branch=master" alt="Build Status" /></a></h1>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ npm install --save read-pkg-up
</code></pre></div></div>

<h2 id="usage">Usage</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">readPkgUp</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'read-pkg-up'</span><span class="p">);</span>

<span class="nx">readPkgUp</span><span class="p">().</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">result</span><span class="p">)</span> <span class="p">{</span>
...
<h3 id="readpkgupsyncoptions">readPkgUp.sync([options])</h3>
