...
<title>normalize-range | estebang23.github.io</title>
<meta name="generator" content="Jekyll v3.7.3" />
<meta property="og:title" content="normalize-range" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/node_modules/normalize-range/" />
<meta property="og:url" content="http://localhost:4000/node_modules/normalize-range/" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/normalize-range/","headline":"normalize-range","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">nr</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'normalize-range'</span><span class="p">);</span>
...
represented as -90˚. 
For wrapping purposes we assume <code class="highlighter-rouge">max</code> is functionally equivalent to <code class="highlighter-rouge">min</code>, and that <code class="highlighter-rouge">wrap(max + 1) === wrap(min + 1)</code>.
Wrap always assumes that <code class="highlighter-rouge">min</code> is <em>inclusive</em>, and <code class="highlighter-rouge">max</code> is <em>exclusive</em>.
In other words, if <code class="highlighter-rouge">value === max</code> the function will wrap it, and return <code class="highlighter-rouge">min</code>, but <code class="highlighter-rouge">min</code> will not be wrapped.</p>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="err">π</span> <span class="o">=</span> <span class="nb">Math</span><span class="p">.</span><span class="nx">PI</span><span class="p">;</span>
<span class="kd">var</span> <span class="nx">radianRange</span> <span class="o">=</span> <span class="nx">nr</span><span class="p">.</span><span class="nx">curry</span><span class="p">(</span><span class="o">-</span><span class="err">π</span><span class="p">,</span> <span class="err">π</span><span class="p">);</span>
...
<span class="nx">nr</span><span class="p">.</span><span class="nx">wrap</span><span class="p">(</span><span class="err">π</span><span class="p">)</span> <span class="o">===</span> <span class="o">-</span><span class="err">π</span><span class="p">;</span>
<span class="nx">nr</span><span class="p">.</span><span class="nx">wrap</span><span class="p">(</span><span class="mi">4</span> <span class="o">*</span> <span class="err">π</span> <span class="o">/</span> <span class="mi">3</span><span class="p">)</span> <span class="o">===</span> <span class="o">-</span><span class="mi">2</span> <span class="o">*</span> <span class="err">π</span> <span class="o">/</span> <span class="mi">3</span><span class="p">;</span>
</code></pre></div></div>

<h3 id="limitmin-max-value">limit(min, max, value)</h3>

<p>Normalize the value by bringing it within the range.
If <code class="highlighter-rouge">value</code> is greater than <code class="highlighter-rouge">max</code>, <code class="highlighter-rouge">max</code> will be returned.
If <code class="highlighter-rouge">value</code> is less than <code class="highlighter-rouge">min</code>, <code class="highlighter-rouge">min</code> will be returned.
Otherwise, <code class="highlighter-rouge">value</code> is returned unaltered.
...
<p>Returns <code class="highlighter-rouge">true</code> if <code class="highlighter-rouge">value</code> is within the range, <code class="highlighter-rouge">false</code> otherwise.
It defaults to <code class="highlighter-rouge">inclusive</code> on both ends of the range, but that can be
changed by setting <code class="highlighter-rouge">minExclusive</code> and/or <code class="highlighter-rouge">maxExclusive</code> to a truthy value.</p>

<h3 id="validatemin-max-value-minexclusive-maxexclusive">validate(min, max, value, [minExclusive], [maxExclusive])</h3>

<p>Returns <code class="highlighter-rouge">value</code> or throws an error if <code class="highlighter-rouge">value</code> is outside the specified range.</p>
...
<p>Convenience method for currying all method arguments except <code class="highlighter-rouge">value</code>.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">angle</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'normalize-range'</span><span class="p">).</span><span class="nx">curry</span><span class="p">(</span><span class="o">-</span><span class="mi">180</span><span class="p">,</span> <span class="mi">180</span><span class="p">,</span> <span class="kc">false</span><span class="p">,</span> <span class="kc">true</span><span class="p">);</span>
...
<p><em>Required</em><br />
Type: <code class="highlighter-rouge">number</code></p>
...
<p>Type: <code class="highlighter-rouge">number</code></p>
...
<ul>
  <li><code class="highlighter-rouge">npm test</code>: tests, linting, coverage and style checks.</li>
  <li><code class="highlighter-rouge">npm run watch</code>: autotest mode for active development.</li>
  <li><code class="highlighter-rouge">npm run debug</code>: run tests without coverage (istanbul can obscure line #’s)</li>
</ul>

<p>Release via <code class="highlighter-rouge">cut-release</code> tool.</p>
