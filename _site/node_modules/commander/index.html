...
<title>Commander.js | estebang23.github.io</title>
<meta name="generator" content="Jekyll v3.7.3" />
<meta property="og:title" content="Commander.js" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/node_modules/commander/" />
<meta property="og:url" content="http://localhost:4000/node_modules/commander/" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/commander/","headline":"Commander.js","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ npm install commander --save
</code></pre></div></div>

<h2 id="option-parsing">Option parsing</h2>

<p>Options with commander are defined with the <code class="highlighter-rouge">.option()</code> method, also serving as documentation for the options. The example below parses args and options from <code class="highlighter-rouge">process.argv</code>, leaving remaining args as the <code class="highlighter-rouge">program.args</code> array which were not consumed by options.</p>
...
<p>Short flags may be passed as a single arg, for example <code class="highlighter-rouge">-abc</code> is equivalent to <code class="highlighter-rouge">-a -b -c</code>. Multi-word options such as “–template-engine” are camel-cased, becoming <code class="highlighter-rouge">program.templateEngine</code> etc.</p>

<p>Note that multi-word options starting with <code class="highlighter-rouge">--no</code> prefix negate the boolean value of the following word. For example, <code class="highlighter-rouge">--no-sauce</code> sets the value of <code class="highlighter-rouge">program.sauce</code> to false.</p>
...
<p>Calling the <code class="highlighter-rouge">version</code> implicitly adds the <code class="highlighter-rouge">-V</code> and <code class="highlighter-rouge">--version</code> options to the command.
When either of these options is present, the command prints the version number and exits.</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ ./examples/pizza -V
0.0.1
</code></pre></div></div>

<p>If you want your program to respond to the <code class="highlighter-rouge">-v</code> option instead of the <code class="highlighter-rouge">-V</code> option, simply pass custom flags to the <code class="highlighter-rouge">version</code> method using the same syntax as the <code class="highlighter-rouge">option</code> method.</p>
...
<span class="nx">program</span>
  ...
  <span class="p">.</span><span class="nx">action</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">dir</span><span class="p">,</span> <span class="nx">cmd</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">'remove '</span> <span class="o">+</span> <span class="nx">dir</span> <span class="o">+</span> <span class="p">(</span><span class="nx">cmd</span><span class="p">.</span><span class="nx">recursive</span> <span class="p">?</span> <span class="s1">' recursively'</span> <span class="p">:</span> <span class="s1">''</span><span class="p">))</span>
  <span class="p">})</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">function</span> <span class="nx">range</span><span class="p">(</span><span class="nx">val</span><span class="p">)</span> <span class="p">{</span>
...
<p>The last argument of a command can be variadic, and only the last argument.  To make an argument variadic you have to
 append <code class="highlighter-rouge">...</code> to the argument name.  Here is an example:</p>
...
<p>An <code class="highlighter-rouge">Array</code> is used for the value of a variadic argument.  This applies to <code class="highlighter-rouge">program.args</code> as well as the argument passed
...
<span class="nx">program</span>
  <span class="p">.</span><span class="nx">version</span><span class="p">(</span><span class="s1">'0.1.0'</span><span class="p">)</span>
  <span class="p">.</span><span class="kr">arguments</span><span class="p">(</span><span class="s1">'&lt;cmd&gt; [env]'</span><span class="p">)</span>
...
<p>Angled brackets (e.g. <code class="highlighter-rouge">&lt;cmd&gt;</code>) indicate required input. Square brackets (e.g. <code class="highlighter-rouge">[env]</code>) indicate optional input.</p>
...
<p>When <code class="highlighter-rouge">.command()</code> is invoked with a description argument, no <code class="highlighter-rouge">.action(callback)</code> should be called to handle sub-commands, otherwise there will be an error. This tells commander that you’re going to use separate executables for sub-commands, much like <code class="highlighter-rouge">git(1)</code> and other popular tools.<br />
The commander will try to search the executables in the directory of the entry script (like <code class="highlighter-rouge">./examples/pm</code>) with the name <code class="highlighter-rouge">program-command</code>, like <code class="highlighter-rouge">pm-install</code>, <code class="highlighter-rouge">pm-search</code>.</p>

<p>Options can be passed with the call to <code class="highlighter-rouge">.command()</code>. Specifying <code class="highlighter-rouge">true</code> for <code class="highlighter-rouge">opts.noHelp</code> will remove the option from the generated help output. Specifying <code class="highlighter-rouge">true</code> for <code class="highlighter-rouge">opts.isDefault</code> will run the subcommand if no other subcommand is specified.</p>

<p>If the program is designed to be installed globally, make sure the executables have proper modes, like <code class="highlighter-rouge">755</code>.</p>

<h3 id="--harmony"><code class="highlighter-rouge">--harmony</code></h3>

<p>You can enable <code class="highlighter-rouge">--harmony</code> option in two ways:</p>
<ul>
  <li>Use <code class="highlighter-rouge"><span class="err">#</span><span class="o">!</span> <span class="sr">/usr/</span><span class="nx">bin</span><span class="o">/</span><span class="nx">env</span> <span class="nx">node</span> <span class="o">--</span><span class="nx">harmony</span></code> in the sub-commands scripts. Note some os version don’t support this pattern.</li>
  <li>Use the <code class="highlighter-rouge">--harmony</code> option when call the command, like <code class="highlighter-rouge">node --harmony examples/pm publish</code>. The <code class="highlighter-rouge">--harmony</code> option will be preserved when spawning sub-command process.</li>
</ul>

<h2 id="automated-help">Automated –help</h2>

<p>The help information is auto-generated based on the information commander already knows about your program, so the following <code class="highlighter-rouge">--help</code> info is for free:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code> $ ./examples/pizza --help
...
<p>You can display arbitrary <code class="highlighter-rouge">-h, --help</code> information
 by listening for “–help”. Commander will automatically
 exit once you are done so that the remainder of your program
 does not execute causing undesired behaviours, for example
 in the following executable “stuff” will not output when
 <code class="highlighter-rouge">--help</code> is used.</p>
...
<p>Yields the following help output when <code class="highlighter-rouge">node script-name.js -h</code> or <code class="highlighter-rouge">node script-name.js --help</code> are run:</p>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">program</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'commander'</span><span class="p">);</span>
