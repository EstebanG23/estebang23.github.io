...
<title>raw-body | estebang23.github.io</title>
<meta name="generator" content="Jekyll v3.7.3" />
<meta property="og:title" content="raw-body" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/node_modules/raw-body/" />
<meta property="og:url" content="http://localhost:4000/node_modules/raw-body/" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/raw-body/","headline":"raw-body","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<p>Gets the entire buffer of a stream either as a <code class="highlighter-rouge">Buffer</code> or a string.
...
<div class="language-sh highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nv">$ </span>npm install raw-body
</code></pre></div></div>
...
types, so install <code class="highlighter-rouge">@types/node</code>:</p>

<div class="language-sh highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nv">$ </span>npm install @types/node
</code></pre></div></div>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">getRawBody</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'raw-body'</span><span class="p">)</span>
</code></pre></div></div>

<h3 id="getrawbodystream-options-callback">getRawBody(stream, [options], [callback])</h3>

<p><strong>Returns a promise if no callback specified and global <code class="highlighter-rouge">Promise</code> exists.</strong></p>

<p>Options:</p>

<ul>
  <li><code class="highlighter-rouge">length</code> - The length of the stream.
If the contents of the stream do not add up to this length,
an <code class="highlighter-rouge">400</code> error code is returned.</li>
  <li><code class="highlighter-rouge">limit</code> - The byte limit of the body.
This is the number of bytes or any string format supported by
<a href="https://www.npmjs.com/package/bytes">bytes</a>,
for example <code class="highlighter-rouge">1000</code>, <code class="highlighter-rouge">'500kb'</code> or <code class="highlighter-rouge">'3mb'</code>.
If the body ends up being larger than this limit,
a <code class="highlighter-rouge">413</code> error code is returned.</li>
  <li><code class="highlighter-rouge">encoding</code> - The encoding to use to decode the body into a string.
By default, a <code class="highlighter-rouge">Buffer</code> instance will be returned when no encoding is specified.
Most likely, you want <code class="highlighter-rouge">utf-8</code>, so setting <code class="highlighter-rouge">encoding</code> to <code class="highlighter-rouge">true</code> will decode as <code class="highlighter-rouge">utf-8</code>.
...
For streams that use file descriptors, you should <code class="highlighter-rouge">stream.destroy()</code> or <code class="highlighter-rouge">stream.close()</code> to prevent leaks.</p>
...
<ul>
  <li><code class="highlighter-rouge">limit</code> - the limit in bytes</li>
  <li><code class="highlighter-rouge">length</code> and <code class="highlighter-rouge">expected</code> - the expected length of the stream</li>
  <li><code class="highlighter-rouge">received</code> - the received bytes</li>
  <li><code class="highlighter-rouge">encoding</code> - the invalid encoding</li>
  <li><code class="highlighter-rouge">status</code> and <code class="highlighter-rouge">statusCode</code> - the corresponding status code for the error</li>
  <li><code class="highlighter-rouge">type</code> - the error type</li>
</ul>

<h3 id="types">Types</h3>

<p>The errors from this module have a <code class="highlighter-rouge">type</code> property which allows for the progamatic
determination of the type of error returned.</p>

<h4 id="encodingunsupported">encoding.unsupported</h4>

<p>This error will occur when the <code class="highlighter-rouge">encoding</code> option is specified, but the value does
...
<p>This error will occur when the <code class="highlighter-rouge">limit</code> option is specified, but the stream has
...
<p>This error will occur when the <code class="highlighter-rouge">length</code> option is specified, but the stream has
...
emit <code class="highlighter-rouge">Buffer</code> objects.</p>

<h2 id="examples">Examples</h2>

<h3 id="simple-express-example">Simple Express example</h3>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">contentType</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'content-type'</span><span class="p">)</span>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">,</span> <span class="nx">next</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">getRawBody</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="p">{</span>
    <span class="na">length</span><span class="p">:</span> <span class="nx">req</span><span class="p">.</span><span class="nx">headers</span><span class="p">[</span><span class="s1">'content-length'</span><span class="p">],</span>
    <span class="na">limit</span><span class="p">:</span> <span class="s1">'1mb'</span><span class="p">,</span>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="kd">function</span> <span class="o">*</span> <span class="p">(</span><span class="nx">next</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">this</span><span class="p">.</span><span class="nx">text</span> <span class="o">=</span> <span class="k">yield</span> <span class="nx">getRawBody</span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">req</span><span class="p">,</span> <span class="p">{</span>
    <span class="na">length</span><span class="p">:</span> <span class="k">this</span><span class="p">.</span><span class="nx">req</span><span class="p">.</span><span class="nx">headers</span><span class="p">[</span><span class="s1">'content-length'</span><span class="p">],</span>
    <span class="na">limit</span><span class="p">:</span> <span class="s1">'1mb'</span><span class="p">,</span>
...
<p>To use this library as a promise, simply omit the <code class="highlighter-rouge">callback</code> and a promise is
returned, provided that a global <code class="highlighter-rouge">Promise</code> is defined.</p>
...
<div class="language-ts highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">import</span> <span class="o">*</span> <span class="k">as</span> <span class="nx">getRawBody</span> <span class="k">from</span> <span class="s1">'raw-body'</span><span class="p">;</span>
...
<p><a href="/node_modules/raw-body/LICENSE">MIT</a></p>
