...
<title>aws4 | estebang23.github.io</title>
<meta name="generator" content="Jekyll v3.7.3" />
<meta property="og:title" content="aws4" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/node_modules/aws4/" />
<meta property="og:url" content="http://localhost:4000/node_modules/aws4/" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/aws4/","headline":"aws4","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// you can also pass AWS credentials in explicitly (otherwise taken from process.env)</span>
...
<span class="c1">// Generate CodeCommit Git access password</span>
<span class="kd">var</span> <span class="nx">signer</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">aws4</span><span class="p">.</span><span class="nx">RequestSigner</span><span class="p">({</span>
  <span class="na">service</span><span class="p">:</span> <span class="s1">'codecommit'</span><span class="p">,</span>
  <span class="na">host</span><span class="p">:</span> <span class="s1">'git-codecommit.us-east-1.amazonaws.com'</span><span class="p">,</span>
  <span class="na">method</span><span class="p">:</span> <span class="s1">'GIT'</span><span class="p">,</span>
  <span class="na">path</span><span class="p">:</span> <span class="s1">'/v1/repos/MyAwesomeRepo'</span><span class="p">,</span>
<span class="p">})</span>
<span class="kd">var</span> <span class="nx">password</span> <span class="o">=</span> <span class="nx">signer</span><span class="p">.</span><span class="nx">getDateTime</span><span class="p">()</span> <span class="o">+</span> <span class="s1">'Z'</span> <span class="o">+</span> <span class="nx">signer</span><span class="p">.</span><span class="nx">signature</span><span class="p">()</span>
</code></pre></div></div>

<h2 id="api">API</h2>

<h3 id="aws4signrequestoptions-credentials">aws4.sign(requestOptions, [credentials])</h3>

<p>This calculates and populates the <code class="highlighter-rouge">Authorization</code> header of
<code class="highlighter-rouge">requestOptions</code>, and any other necessary AWS headers and/or request
options. Returns <code class="highlighter-rouge">requestOptions</code> as a convenience for chaining.</p>

<p><code class="highlighter-rouge">requestOptions</code> is an object holding the same options that the node.js
<a href="http://nodejs.org/docs/latest/api/http.html#http_http_request_options_callback">http.request</a>
function takes.</p>

<p>The following properties of <code class="highlighter-rouge">requestOptions</code> are used in the signing or
populated if they don’t already exist:</p>

<ul>
  <li><code class="highlighter-rouge">hostname</code> or <code class="highlighter-rouge">host</code> (will be determined from <code class="highlighter-rouge">service</code> and <code class="highlighter-rouge">region</code> if not given)</li>
  <li><code class="highlighter-rouge">method</code> (will use <code class="highlighter-rouge">'GET'</code> if not given or <code class="highlighter-rouge">'POST'</code> if there is a <code class="highlighter-rouge">body</code>)</li>
  <li><code class="highlighter-rouge">path</code> (will use <code class="highlighter-rouge">'/'</code> if not given)</li>
  <li><code class="highlighter-rouge">body</code> (will use <code class="highlighter-rouge">''</code> if not given)</li>
  <li><code class="highlighter-rouge">service</code> (will be calculated from <code class="highlighter-rouge">hostname</code> or <code class="highlighter-rouge">host</code> if not given)</li>
  <li><code class="highlighter-rouge">region</code> (will be calculated from <code class="highlighter-rouge">hostname</code> or <code class="highlighter-rouge">host</code> or use <code class="highlighter-rouge">'us-east-1'</code> if not given)</li>
  <li><code class="highlighter-rouge">headers['Host']</code> (will use <code class="highlighter-rouge">hostname</code> or <code class="highlighter-rouge">host</code> or be calculated if not given)</li>
  <li><code class="highlighter-rouge">headers['Content-Type']</code> (will use <code class="highlighter-rouge">'application/x-www-form-urlencoded; charset=utf-8'</code>
if not given and there is a <code class="highlighter-rouge">body</code>)</li>
  <li><code class="highlighter-rouge">headers['Date']</code> (used to calculate the signature date if given, otherwise <code class="highlighter-rouge">new Date</code> is used)</li>
</ul>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">aws4</span><span class="p">.</span><span class="nx">sign</span><span class="p">(</span><span class="nx">requestOptions</span><span class="p">,</span> <span class="p">{</span>
...
<ul>
  <li>From <code class="highlighter-rouge">process.env</code>, such as this:</li>
</ul>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>export AWS_SECRET_ACCESS_KEY="&lt;your-secret-access-key&gt;"
export AWS_ACCESS_KEY_ID="&lt;your-access-key-id&gt;"
export AWS_SESSION_TOKEN="&lt;your-session-token&gt;"
</code></pre></div></div>

<p>(will also use <code class="highlighter-rouge">AWS_ACCESS_KEY</code> and <code class="highlighter-rouge">AWS_SECRET_KEY</code> if available)</p>

<p>The <code class="highlighter-rouge">sessionToken</code> property and <code class="highlighter-rouge">AWS_SESSION_TOKEN</code> environment variable are optional for signing
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm install aws4
</code></pre></div></div>
