...
<link rel="canonical" href="http://localhost:4000/node_modules/q/" />
<meta property="og:url" content="http://localhost:4000/node_modules/q/" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/q/","headline":"estebang23.github.io","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<p>With this approach, you also get implicit error propagation, just like <code class="highlighter-rouge">try</code>,
<code class="highlighter-rouge">catch</code>, and <code class="highlighter-rouge">finally</code>.  An error in <code class="highlighter-rouge">promisedStep1</code> will flow all the way to
the <code class="highlighter-rouge">catch</code> function, where it’s caught and handled.  (Here <code class="highlighter-rouge">promisedStepN</code> is
a version of <code class="highlighter-rouge">stepN</code> that returns a promise.)</p>
...
<ul>
  <li>A <code class="highlighter-rouge">&lt;script&gt;</code> tag (creating a <code class="highlighter-rouge">Q</code> global variable): ~2.5 KB minified and
gzipped.</li>
...
the <a href="https://npmjs.org/package/q">q</a> package</li>
  <li>An AMD module</li>
  <li>A <a href="https://github.com/component/component">component</a> as <code class="highlighter-rouge">microjs/q</code></li>
  <li>Using <a href="http://bower.io/">bower</a> as <code class="highlighter-rouge">q#^1.4.1</code></li>
...
<a href="https://github.com/kriskowal/q/wiki/General-Promise-Resources">presentations, blog posts, and podcasts</a>.</li>
  <li>A guide for those <a href="https://github.com/kriskowal/q/wiki/Coming-from-jQuery">coming from jQuery’s <code class="highlighter-rouge">$.Deferred</code></a>.</li>
</ul>
...
<p>Promises have a <code class="highlighter-rouge">then</code> method, which you can use to get the eventual
...
<p>If <code class="highlighter-rouge">promiseMeSomething</code> returns a promise that gets fulfilled later
with a return value, the first function (the fulfillment handler) will be
called with the value.  However, if the <code class="highlighter-rouge">promiseMeSomething</code> function
...
event loop (i.e. <code class="highlighter-rouge">process.nextTick</code> in Node). This gives you a nice
guarantee when mentally tracing the flow of your code, namely that
<code class="highlighter-rouge">then</code> will always return before either handler is executed.</p>

<p>In this tutorial, we begin with how to consume and work with promises. We’ll
talk about how to create them, and thus create functions like
<code class="highlighter-rouge">promiseMeSomething</code> that return promises, <a href="#the-beginning">below</a>.</p>

<h3 id="propagation">Propagation</h3>

<p>The <code class="highlighter-rouge">then</code> method returns a promise, which in this example, I’m
assigning to <code class="highlighter-rouge">outputPromise</code>.</p>
...
<p>The <code class="highlighter-rouge">outputPromise</code> variable becomes a new promise for the return
value of either handler.  Since a function can only either return a
value or throw an exception, only one handler will ever be called and it
will be responsible for resolving <code class="highlighter-rouge">outputPromise</code>.</p>

<ul>
  <li>
    <p>If you return a value in a handler, <code class="highlighter-rouge">outputPromise</code> will get
fulfilled.</p>
  </li>
  <li>
    <p>If you throw an exception in a handler, <code class="highlighter-rouge">outputPromise</code> will get
rejected.</p>
  </li>
  <li>
    <p>If you return a <strong>promise</strong> in a handler, <code class="highlighter-rouge">outputPromise</code> will
“become” that promise.  Being able to become a new promise is useful
for managing delays, combining results, or recovering from errors.</p>
  </li>
</ul>

<p>If the <code class="highlighter-rouge">getInputPromise()</code> promise gets rejected and you omit the
rejection handler, the <strong>error</strong> will go to <code class="highlighter-rouge">outputPromise</code>:</p>
...
<strong>value</strong> will go to <code class="highlighter-rouge">outputPromise</code>:</p>
...
<p>Q promises provide a <code class="highlighter-rouge">fail</code> shorthand for <code class="highlighter-rouge">then</code> when you are only
...
CoffeeScript, you may use <code class="highlighter-rouge">catch</code> instead of <code class="highlighter-rouge">fail</code>.</p>

<p>Promises also have a <code class="highlighter-rouge">fin</code> function that is like a <code class="highlighter-rouge">finally</code> clause.
The final handler gets called, with no arguments, when the promise
returned by <code class="highlighter-rouge">getInputPromise()</code> either returns a value or throws an
error.  The value returned or error thrown by <code class="highlighter-rouge">getInputPromise()</code>
passes directly to <code class="highlighter-rouge">outputPromise</code> unless the final handler fails, and
...
<ul>
  ...
  <li>If the handler throws an error, the error passes to <code class="highlighter-rouge">outputPromise</code></li>
  <li>If the handler returns a promise, <code class="highlighter-rouge">outputPromise</code> gets postponed.  The
...
<p>If you are writing JavaScript for modern engines only or using
CoffeeScript, you may use <code class="highlighter-rouge">finally</code> instead of <code class="highlighter-rouge">fin</code>.</p>
...
fulfilled array using <code class="highlighter-rouge">all</code>.</p>
...
<p>If you have a promise for an array, you can use <code class="highlighter-rouge">spread</code> as a
replacement for <code class="highlighter-rouge">then</code>.  The <code class="highlighter-rouge">spread</code> function “spreads” the
...
<p>But <code class="highlighter-rouge">spread</code> calls <code class="highlighter-rouge">all</code> initially, so you can skip it in chains.</p>
...
<p>The <code class="highlighter-rouge">all</code> function returns a promise for an array of values.  When this
promise is fulfilled, the array contains the fulfillment values of the original
promises, in the same order as those promises.  If one of the given promises
is rejected, the returned promise is immediately rejected, not waiting for the
rest of the batch.  If you want to wait for all of the promises to either be
fulfilled or rejected, you can use <code class="highlighter-rouge">allSettled</code>.</p>
...
<p>The <code class="highlighter-rouge">any</code> function accepts an array of promises and returns a promise that is
...
<p>You can make this slightly more compact using <code class="highlighter-rouge">reduce</code>:</p>
...
<code class="highlighter-rouge">try</code>/<code class="highlighter-rouge">catch</code>. We are <code class="highlighter-rouge">try</code>-ing to execute <code class="highlighter-rouge">foo()</code>: the error
handler represents a <code class="highlighter-rouge">catch</code> for <code class="highlighter-rouge">foo()</code>, while the fulfillment handler
represents code that happens <em>after</em> the <code class="highlighter-rouge">try</code>/<code class="highlighter-rouge">catch</code> block.
That code then needs its own <code class="highlighter-rouge">try</code>/<code class="highlighter-rouge">catch</code> block.</p>
...
a third parameter to <code class="highlighter-rouge">then</code>:</p>
...
<p>Like <code class="highlighter-rouge">fail</code>, Q also provides a shorthand for progress callbacks
called <code class="highlighter-rouge">progress</code>:</p>
...
<h4 id="using-qfcall">Using <code class="highlighter-rouge">Q.fcall</code></h4>

<p>You can create a promise from a value using <code class="highlighter-rouge">Q.fcall</code>.  This returns a
promise for 10.</p>
...
<p>You can also use <code class="highlighter-rouge">fcall</code> to get a promise for an exception.</p>
...
<p>As the name implies, <code class="highlighter-rouge">fcall</code> can call functions, or even promised
functions.  This uses the <code class="highlighter-rouge">eventualAdd</code> function above to add two
numbers.</p>
...
instead of promise-based, Q provides a few shortcuts (like <code class="highlighter-rouge">Q.nfcall</code> and
...
<code class="highlighter-rouge">reject</code> function is a shorthand for resolving with a rejected
promise.</p>
...
<p>This is a simplified implementation of <code class="highlighter-rouge">Q.delay</code>.</p>
...
<p>This is a simplified implementation of <code class="highlighter-rouge">Q.timeout</code></p>
...
<code class="highlighter-rouge">deferred.notify</code>.</p>
...
<p>Below is an example of how to use this <code class="highlighter-rouge">requestOkText</code> function:</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">requestOkText</span><span class="p">(</span><span class="s2">"http://localhost:3000"</span><span class="p">)</span>
...
<h4 id="using-qpromise">Using <code class="highlighter-rouge">Q.Promise</code></h4>
...
<p>Rewriting the <code class="highlighter-rouge">requestOkText</code> example above using <code class="highlighter-rouge">Q.Promise</code>:</p>
...
<p>If <code class="highlighter-rouge">requestOkText</code> were to throw an exception, the returned promise would be
...
<p>The <code class="highlighter-rouge">when</code> function is the static equivalent for <code class="highlighter-rouge">then</code>.</p>
...
Most libraries only provide a partially functional <code class="highlighter-rouge">then</code> method.
...
You can even use <code class="highlighter-rouge">Q.invoke</code> as a shorthand.</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">return</span> <span class="nx">Q</span><span class="p">.</span><span class="nx">invoke</span><span class="p">(</span><span class="nx">$</span><span class="p">,</span> <span class="s1">'ajax'</span><span class="p">,</span> <span class="p">...)</span>
<span class="p">.</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">()</span> <span class="p">{</span>
<span class="p">});</span>
</code></pre></div></div>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>direct manipulation         using a promise as a proxy
--------------------------  -------------------------------
...
round-trips by using these functions instead of <code class="highlighter-rouge">then</code>.  To take
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">return</span> <span class="nx">Q</span><span class="p">.</span><span class="nx">fcall</span><span class="p">(</span><span class="kd">function</span> <span class="p">()</span> <span class="p">{</span>
    <span class="k">return</span> <span class="p">[{</span> <span class="na">foo</span><span class="p">:</span> <span class="s2">"bar"</span> <span class="p">},</span> <span class="p">{</span> <span class="na">foo</span><span class="p">:</span> <span class="s2">"baz"</span> <span class="p">}];</span>
<span class="p">})</span>
<span class="p">.</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">value</span><span class="p">)</span> <span class="p">{</span>
...
<span class="p">.</span><span class="kd">get</span><span class="p">(</span><span class="s2">"foo"</span><span class="p">);</span>
</code></pre></div></div>

<h3 id="adapting-node">Adapting Node</h3>

<p>If you’re working with functions that make use of the Node.js callback pattern,
where callbacks are in the form of <code class="highlighter-rouge">function(err, result)</code>, Q provides a few
useful utility functions for converting between them. The most straightforward
are probably <code class="highlighter-rouge">Q.nfcall</code> and <code class="highlighter-rouge">Q.nfapply</code> (“Node function call/apply”) for calling
Node.js-style functions and getting back a promise:</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">return</span> <span class="nx">Q</span><span class="p">.</span><span class="nx">nfcall</span><span class="p">(</span><span class="nx">FS</span><span class="p">.</span><span class="nx">readFile</span><span class="p">,</span> <span class="s2">"foo.txt"</span><span class="p">,</span> <span class="s2">"utf-8"</span><span class="p">);</span>
...
<code class="highlighter-rouge">Q.nfcall</code>—”un-binds” the method from its owner. To avoid this, you can either
use <code class="highlighter-rouge">Function.prototype.bind</code> or some nice shortcut methods we provide:</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">return</span> <span class="nx">Q</span><span class="p">.</span><span class="nx">ninvoke</span><span class="p">(</span><span class="nx">redisClient</span><span class="p">,</span> <span class="s2">"get"</span><span class="p">,</span> <span class="s2">"user:1:id"</span><span class="p">);</span>
...
<p>You can also create reusable wrappers with <code class="highlighter-rouge">Q.denodeify</code> or <code class="highlighter-rouge">Q.nbind</code>:</p>
...
<code class="highlighter-rouge">makeNodeResolver</code> method on deferreds that can be handy:</p>
...
<p>Q comes with optional support for “long stack traces,” wherein the <code class="highlighter-rouge">stack</code>
property of <code class="highlighter-rouge">Error</code> rejection reasons is rewritten to be traced along
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>Error: boo!
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>Q_DEBUG=1 node server.js
</code></pre></div></div>
