...
<title>Forge | estebang23.github.io</title>
<meta name="generator" content="Jekyll v3.7.3" />
<meta property="og:title" content="Forge" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/node_modules/node-forge/" />
<meta property="og:url" content="http://localhost:4000/node_modules/node-forge/" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/node-forge/","headline":"Forge","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<p><a href="https://nodei.co/npm/node-forge/"><img src="https://nodei.co/npm/node-forge.png?downloads=true&amp;downloadRank=true&amp;stars=true" alt="npm package" /></a></p>

<p><a href="https://travis-ci.org/digitalbazaar/forge"><img src="https://img.shields.io/travis/digitalbazaar/forge.svg?branch=master" alt="Build status" /></a></p>
...
<p>If you want to use forge with <a href="http://nodejs.org/">Node.js</a>, it is available through <code class="highlighter-rouge">npm</code>:</p>

<p>https://npmjs.org/package/node-forge</p>

<p>Installation:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm install node-forge
</code></pre></div></div>

<p>You can then use forge as a regular module:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">forge</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'node-forge'</span><span class="p">);</span>
</code></pre></div></div>

<p>The npm package includes pre-built <code class="highlighter-rouge">forge.min.js</code>, <code class="highlighter-rouge">forge.all.min.js</code>, and
<code class="highlighter-rouge">prime.worker.min.js</code> using the <a href="https://github.com/umdjs/umd">UMD</a> format.</p>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>bower install forge
</code></pre></div></div>

<h3 id="unpkg">unpkg</h3>

<p><a href="https://unpkg.com/">unpkg</a> provides a CDN that can serve files from npm packages directly.</p>

<p>https://unpkg.com/node-forge@0.7.0/dist/forge.min.js</p>
...
<a href="/node_modules/node-forge/flash/">Flash README</a> for details.</p>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>dist/forge.js
dist/forge.min.js
</code></pre></div></div>

<p>A bundle that adds some utilities and networking support is also available:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>dist/forge.all.js
dist/forge.all.min.js
</code></pre></div></div>

<p>Include the file via:</p>

<div class="language-html highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"YOUR_SCRIPT_PATH/forge.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre></div></div>
<p>or</p>
<div class="language-html highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"YOUR_SCRIPT_PATH/forge.min.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre></div></div>
...
<code class="highlighter-rouge">dist/prime.worker.js</code>), so these will need to be accessible from the browser
...
<p><a href="http://browserify.org/">Browserify</a> override support is also present in <code class="highlighter-rouge">package.json</code>.</p>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm run test-karma
</code></pre></div></div>

<p>Is ‘mocha’ reporter output too verbose? Other reporters are available. Try
‘dots’, ‘progress’, or ‘tap’.</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm run test-karma -- --reporters progress
</code></pre></div></div>

<p>By default <a href="https://webpack.github.io/">webpack</a> is used. <a href="http://browserify.org/">Browserify</a> can also be used.</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>BUNDLER=browserify npm run test-karma
</code></pre></div></div>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm run test-karma -- --browsers Chrome,Firefox,Safari,PhantomJS
</code></pre></div></div>

<p>The reporter option and <code class="highlighter-rouge">BUNDLER</code> environment variable can also be used.</p>
...
used by running <code class="highlighter-rouge">node tests/server.js</code> manually.</p>

<p>To run the unit tests in a browser a special forge build is required:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm run test-build
</code></pre></div></div>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm run test-server
</code></pre></div></div>
...
will be put in the <code class="highlighter-rouge">coverage/</code> directory. Note that coverage testing can slow
...
may set the <code class="highlighter-rouge">forge.options.usePureJavaScript</code> flag to <code class="highlighter-rouge">true</code>. It is
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// run this *after* including the forge script</span>
...
<h2 id="transports-1">Transports</h2>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// create TLS client</span>
<span class="kd">var</span> <span class="nx">client</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">tls</span><span class="p">.</span><span class="nx">createConnection</span><span class="p">({</span>
  <span class="na">server</span><span class="p">:</span> <span class="kc">false</span><span class="p">,</span>
  <span class="na">caStore</span><span class="p">:</span> <span class="cm">/* Array of PEM-formatted certs or a CA store object */</span><span class="p">,</span>
  <span class="na">sessionCache</span><span class="p">:</span> <span class="p">{},</span>
  <span class="c1">// supported cipher suites in order of preference</span>
  <span class="na">cipherSuites</span><span class="p">:</span> <span class="p">[</span>
  ...
  <span class="na">virtualHost</span><span class="p">:</span> <span class="s1">'example.com'</span><span class="p">,</span>
  <span class="na">verify</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">,</span> <span class="nx">verified</span><span class="p">,</span> <span class="nx">depth</span><span class="p">,</span> <span class="nx">certs</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">if</span><span class="p">(</span><span class="nx">depth</span> <span class="o">===</span> <span class="mi">0</span><span class="p">)</span> <span class="p">{</span>
      ...
      <span class="k">if</span><span class="p">(</span><span class="nx">cn</span> <span class="o">!==</span> <span class="s1">'example.com'</span><span class="p">)</span> <span class="p">{</span>
        <span class="nx">verified</span> <span class="o">=</span> <span class="p">{</span>
          <span class="na">alert</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">tls</span><span class="p">.</span><span class="nx">Alert</span><span class="p">.</span><span class="nx">Description</span><span class="p">.</span><span class="nx">bad_certificate</span><span class="p">,</span>
          <span class="na">message</span><span class="p">:</span> <span class="s1">'Certificate common name does not match hostname.'</span>
        <span class="p">};</span>
      <span class="p">}</span>
    <span class="p">}</span>
    <span class="k">return</span> <span class="nx">verified</span><span class="p">;</span>
  <span class="p">},</span>
  <span class="na">connected</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="cm">/* NOTE: experimental, start heartbeat retransmission timer
    myHeartbeatTimer = setInterval(function() {
      connection.prepareHeartbeatRequest(forge.util.createBuffer('1234'));
    }, 5*60*1000);*/</span>
  <span class="p">},</span>
  <span class="cm">/* provide a client-side cert if you want
  getCertificate: function(connection, hint) {
    return myClientCertificate;
  },
  /* the private key for the client-side cert if provided */</span>
  <span class="na">getPrivateKey</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">,</span> <span class="nx">cert</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">return</span> <span class="nx">myClientPrivateKey</span><span class="p">;</span>
  <span class="p">},</span>
  <span class="na">tlsDataReady</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
  ...
  <span class="p">},</span>
  <span class="na">dataReady</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
  ...
  <span class="p">},</span>
  <span class="cm">/* NOTE: experimental
  ...
  <span class="na">closed</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
  ...
  <span class="p">},</span>
  <span class="na">error</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">,</span> <span class="nx">error</span><span class="p">)</span> <span class="p">{</span>
...
<span class="kd">var</span> <span class="nx">server</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">tls</span><span class="p">.</span><span class="nx">createConnection</span><span class="p">({</span>
  ...
  <span class="na">verifyClient</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
  <span class="na">verify</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">,</span> <span class="nx">verified</span><span class="p">,</span> <span class="nx">depth</span><span class="p">,</span> <span class="nx">certs</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">if</span><span class="p">(</span><span class="nx">depth</span> <span class="o">===</span> <span class="mi">0</span><span class="p">)</span> <span class="p">{</span>
      <span class="kd">var</span> <span class="nx">cn</span> <span class="o">=</span> <span class="nx">certs</span><span class="p">[</span><span class="mi">0</span><span class="p">].</span><span class="nx">subject</span><span class="p">.</span><span class="nx">getField</span><span class="p">(</span><span class="s1">'CN'</span><span class="p">).</span><span class="nx">value</span><span class="p">;</span>
      <span class="k">if</span><span class="p">(</span><span class="nx">cn</span> <span class="o">!==</span> <span class="s1">'the-client'</span><span class="p">)</span> <span class="p">{</span>
        <span class="nx">verified</span> <span class="o">=</span> <span class="p">{</span>
          <span class="na">alert</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">tls</span><span class="p">.</span><span class="nx">Alert</span><span class="p">.</span><span class="nx">Description</span><span class="p">.</span><span class="nx">bad_certificate</span><span class="p">,</span>
          <span class="na">message</span><span class="p">:</span> <span class="s1">'Certificate common name does not match expected client.'</span>
        <span class="p">};</span>
      <span class="p">}</span>
    <span class="p">}</span>
    <span class="k">return</span> <span class="nx">verified</span><span class="p">;</span>
  ...
  <span class="p">},</span>
  <span class="na">getCertificate</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">,</span> <span class="nx">hint</span><span class="p">)</span> <span class="p">{</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">socket</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">net</span><span class="p">.</span><span class="nx">Socket</span><span class="p">();</span>
...
<span class="kd">var</span> <span class="nx">client</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">tls</span><span class="p">.</span><span class="nx">createConnection</span><span class="p">({</span>
  ...
  <span class="na">connected</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="nx">client</span><span class="p">.</span><span class="nx">prepare</span><span class="p">(</span><span class="s1">'GET / HTTP/1.0</span><span class="err">\</span><span class="s1">r</span><span class="err">\</span><span class="s1">n</span><span class="err">\</span><span class="s1">r</span><span class="err">\</span><span class="s1">n'</span><span class="p">);</span>
  <span class="p">},</span>
  <span class="na">tlsDataReady</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// create an HTTP GET request</span>
<span class="kd">var</span> <span class="nx">request</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">http</span><span class="p">.</span><span class="nx">createRequest</span><span class="p">({</span><span class="na">method</span><span class="p">:</span> <span class="s1">'GET'</span><span class="p">,</span> <span class="na">path</span><span class="p">:</span> <span class="nx">url</span><span class="p">.</span><span class="nx">path</span><span class="p">});</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// encodes (and optionally encrypts) a private RSA key as a Putty PPK file</span>
...
<span class="nx">forge</span><span class="p">.</span><span class="nx">ssh</span><span class="p">.</span><span class="nx">getPublicKeyFingerprint</span><span class="p">(</span><span class="nx">key</span><span class="p">,</span> <span class="p">{</span><span class="na">encoding</span><span class="p">:</span> <span class="s1">'hex'</span><span class="p">,</span> <span class="na">delimiter</span><span class="p">:</span> <span class="s1">':'</span><span class="p">});</span>
</code></pre></div></div>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// TODO</span>
</code></pre></div></div>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// generate a random key and IV</span>
...
<span class="cm">/* alternatively, generate a password-based 16-byte key
...
<span class="nx">decipher</span><span class="p">.</span><span class="nx">start</span><span class="p">({</span><span class="na">iv</span><span class="p">:</span> <span class="nx">iv</span><span class="p">});</span>
...
<span class="nx">cipher</span><span class="p">.</span><span class="nx">start</span><span class="p">({</span>
  <span class="na">iv</span><span class="p">:</span> <span class="nx">iv</span><span class="p">,</span> <span class="c1">// should be a 12-byte binary-encoded string or byte buffer</span>
  <span class="na">additionalData</span><span class="p">:</span> <span class="s1">'binary-encoded string'</span><span class="p">,</span> <span class="c1">// optional</span>
  <span class="na">tagLength</span><span class="p">:</span> <span class="mi">128</span> <span class="c1">// optional, defaults to 128 bits</span>
<span class="p">});</span>
<span class="nx">cipher</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">createBuffer</span><span class="p">(</span><span class="nx">someBytes</span><span class="p">));</span>
<span class="nx">cipher</span><span class="p">.</span><span class="nx">finish</span><span class="p">();</span>
<span class="kd">var</span> <span class="nx">encrypted</span> <span class="o">=</span> <span class="nx">cipher</span><span class="p">.</span><span class="nx">output</span><span class="p">;</span>
...
<span class="nx">decipher</span><span class="p">.</span><span class="nx">start</span><span class="p">({</span>
  ...
  <span class="na">additionalData</span><span class="p">:</span> <span class="s1">'binary-encoded string'</span><span class="p">,</span> <span class="c1">// optional</span>
  <span class="na">tagLength</span><span class="p">:</span> <span class="mi">128</span><span class="p">,</span> <span class="c1">// optional, defaults to 128 bits</span>
  <span class="na">tag</span><span class="p">:</span> <span class="nx">tag</span> <span class="c1">// authentication tag from encryption</span>
<span class="p">});</span>
<span class="nx">decipher</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="nx">encrypted</span><span class="p">);</span>
...
<span class="kd">function</span> <span class="nx">encrypt</span><span class="p">(</span><span class="nx">password</span><span class="p">)</span> <span class="p">{</span>
  <span class="kd">var</span> <span class="nx">input</span> <span class="o">=</span> <span class="nx">fs</span><span class="p">.</span><span class="nx">readFileSync</span><span class="p">(</span><span class="s1">'input.txt'</span><span class="p">,</span> <span class="p">{</span><span class="na">encoding</span><span class="p">:</span> <span class="s1">'binary'</span><span class="p">});</span>
  ...
  <span class="nx">fs</span><span class="p">.</span><span class="nx">writeFileSync</span><span class="p">(</span><span class="s1">'input.enc'</span><span class="p">,</span> <span class="nx">output</span><span class="p">.</span><span class="nx">getBytes</span><span class="p">(),</span> <span class="p">{</span><span class="na">encoding</span><span class="p">:</span> <span class="s1">'binary'</span><span class="p">});</span>
<span class="p">}</span>
...
<span class="kd">function</span> <span class="nx">decrypt</span><span class="p">(</span><span class="nx">password</span><span class="p">)</span> <span class="p">{</span>
  <span class="kd">var</span> <span class="nx">input</span> <span class="o">=</span> <span class="nx">fs</span><span class="p">.</span><span class="nx">readFileSync</span><span class="p">(</span><span class="s1">'input.enc'</span><span class="p">,</span> <span class="p">{</span><span class="na">encoding</span><span class="p">:</span> <span class="s1">'binary'</span><span class="p">});</span>
  ...
  <span class="nx">fs</span><span class="p">.</span><span class="nx">writeFileSync</span><span class="p">(</span>
    <span class="s1">'input.dec.txt'</span><span class="p">,</span> <span class="nx">decipher</span><span class="p">.</span><span class="nx">output</span><span class="p">.</span><span class="nx">getBytes</span><span class="p">(),</span> <span class="p">{</span><span class="na">encoding</span><span class="p">:</span> <span class="s1">'binary'</span><span class="p">});</span>
<span class="p">}</span>
</code></pre></div></div>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">rsa</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pki</span><span class="p">.</span><span class="nx">rsa</span><span class="p">;</span>
...
<span class="kd">var</span> <span class="nx">keypair</span> <span class="o">=</span> <span class="nx">rsa</span><span class="p">.</span><span class="nx">generateKeyPair</span><span class="p">({</span><span class="na">bits</span><span class="p">:</span> <span class="mi">2048</span><span class="p">,</span> <span class="na">e</span><span class="p">:</span> <span class="mh">0x10001</span><span class="p">});</span>
...
<span class="nx">rsa</span><span class="p">.</span><span class="nx">generateKeyPair</span><span class="p">({</span><span class="na">bits</span><span class="p">:</span> <span class="mi">2048</span><span class="p">,</span> <span class="na">workers</span><span class="p">:</span> <span class="mi">2</span><span class="p">},</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">keypair</span><span class="p">)</span> <span class="p">{</span>
...
<span class="kd">var</span> <span class="nx">pss</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pss</span><span class="p">.</span><span class="nx">create</span><span class="p">({</span>
  <span class="na">md</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">md</span><span class="p">.</span><span class="nx">sha1</span><span class="p">.</span><span class="nx">create</span><span class="p">(),</span>
  <span class="na">mgf</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">mgf</span><span class="p">.</span><span class="nx">mgf1</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="nx">forge</span><span class="p">.</span><span class="nx">md</span><span class="p">.</span><span class="nx">sha1</span><span class="p">.</span><span class="nx">create</span><span class="p">()),</span>
  <span class="na">saltLength</span><span class="p">:</span> <span class="mi">20</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// generate an RSA key pair asynchronously (uses web workers if available)</span>
<span class="c1">// use workers: -1 to run a fast core estimator to optimize # of workers</span>
<span class="nx">forge</span><span class="p">.</span><span class="nx">rsa</span><span class="p">.</span><span class="nx">generateKeyPair</span><span class="p">({</span><span class="na">bits</span><span class="p">:</span> <span class="mi">2048</span><span class="p">,</span> <span class="na">workers</span><span class="p">:</span> <span class="o">-</span><span class="mi">1</span><span class="p">},</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">keypair</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// keypair.privateKey, keypair.publicKey</span>
<span class="p">});</span>
...
<span class="c1">// decrypt some bytes</span>
<span class="kd">var</span> <span class="nx">decipher</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">cipher</span><span class="p">.</span><span class="nx">createDecipher</span><span class="p">(</span><span class="s1">'AES-GCM'</span><span class="p">,</span> <span class="nx">key</span><span class="p">);</span>
<span class="nx">decipher</span><span class="p">.</span><span class="nx">start</span><span class="p">({</span><span class="na">iv</span><span class="p">:</span> <span class="nx">iv</span><span class="p">,</span> <span class="na">tag</span><span class="p">:</span> <span class="nx">tag</span><span class="p">});</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">pki</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pki</span><span class="p">;</span>
...
<span class="nx">pki</span><span class="p">.</span><span class="nx">getPublicKeyFingerprint</span><span class="p">(</span><span class="nx">key</span><span class="p">,</span> <span class="p">{</span><span class="na">type</span><span class="p">:</span> <span class="s1">'SubjectPublicKeyInfo'</span><span class="p">});</span>

<span class="c1">// gets a hex-encoded, colon-delimited SHA-1 RSAPublicKey public key fingerprint</span>
<span class="nx">pki</span><span class="p">.</span><span class="nx">getPublicKeyFingerprint</span><span class="p">(</span><span class="nx">key</span><span class="p">,</span> <span class="p">{</span><span class="na">encoding</span><span class="p">:</span> <span class="s1">'hex'</span><span class="p">,</span> <span class="na">delimiter</span><span class="p">:</span> <span class="s1">':'</span><span class="p">});</span>
...
<span class="nx">pki</span><span class="p">.</span><span class="nx">getPublicKeyFingerprint</span><span class="p">(</span><span class="nx">key</span><span class="p">,</span> <span class="p">{</span>
  <span class="na">type</span><span class="p">:</span> <span class="s1">'SubjectPublicKeyInfo'</span><span class="p">,</span>
  <span class="na">encoding</span><span class="p">:</span> <span class="s1">'hex'</span><span class="p">,</span>
  <span class="na">delimiter</span><span class="p">:</span> <span class="s1">':'</span>
<span class="p">});</span>

<span class="c1">// gets a hex-encoded, colon-delimited MD5 RSAPublicKey public key fingerprint</span>
<span class="nx">pki</span><span class="p">.</span><span class="nx">getPublicKeyFingerprint</span><span class="p">(</span><span class="nx">key</span><span class="p">,</span> <span class="p">{</span>
  <span class="na">md</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">md</span><span class="p">.</span><span class="nx">md5</span><span class="p">.</span><span class="nx">create</span><span class="p">(),</span>
  <span class="na">encoding</span><span class="p">:</span> <span class="s1">'hex'</span><span class="p">,</span>
  <span class="na">delimiter</span><span class="p">:</span> <span class="s1">':'</span>
<span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">attrs</span> <span class="o">=</span> <span class="p">[{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'commonName'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="s1">'example.org'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'countryName'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="s1">'US'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">shortName</span><span class="p">:</span> <span class="s1">'ST'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="s1">'Virginia'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'localityName'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="s1">'Blacksburg'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'organizationName'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="s1">'Test'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">shortName</span><span class="p">:</span> <span class="s1">'OU'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="s1">'Test'</span>
<span class="p">}];</span>
...
<span class="nx">cert</span><span class="p">.</span><span class="nx">setExtensions</span><span class="p">([{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'basicConstraints'</span><span class="p">,</span>
  <span class="na">cA</span><span class="p">:</span> <span class="kc">true</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'keyUsage'</span><span class="p">,</span>
  ...
  <span class="na">keyEncipherment</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
  <span class="na">dataEncipherment</span><span class="p">:</span> <span class="kc">true</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'extKeyUsage'</span><span class="p">,</span>
  <span class="na">serverAuth</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
  <span class="na">clientAuth</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
  <span class="na">codeSigning</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
  <span class="na">emailProtection</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
  <span class="na">timeStamping</span><span class="p">:</span> <span class="kc">true</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'nsCertType'</span><span class="p">,</span>
  ...
  <span class="na">objsign</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
  <span class="na">sslCA</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
  <span class="na">emailCA</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
  <span class="na">objCA</span><span class="p">:</span> <span class="kc">true</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'subjectAltName'</span><span class="p">,</span>
  <span class="na">altNames</span><span class="p">:</span> <span class="p">[{</span>
    <span class="na">type</span><span class="p">:</span> <span class="mi">6</span><span class="p">,</span> <span class="c1">// URI</span>
    <span class="na">value</span><span class="p">:</span> <span class="s1">'http://example.org/webid#me'</span>
  <span class="p">},</span> <span class="p">{</span>
    <span class="na">type</span><span class="p">:</span> <span class="mi">7</span><span class="p">,</span> <span class="c1">// IP</span>
    <span class="na">ip</span><span class="p">:</span> <span class="s1">'127.0.0.1'</span>
  <span class="p">}]</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'subjectKeyIdentifier'</span>
<span class="p">}]);</span>
<span class="cm">/* alternatively set extensions from a csr
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// generate a password-based 16-byte key</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// convert a message from PEM</span>
...
<span class="nx">p7</span><span class="p">.</span><span class="nx">addSigner</span><span class="p">({</span>
  <span class="na">key</span><span class="p">:</span> <span class="nx">privateKeyAssociatedWithCert</span><span class="p">,</span>
  <span class="na">certificate</span><span class="p">:</span> <span class="nx">certOrCertPem</span><span class="p">,</span>
  <span class="na">digestAlgorithm</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pki</span><span class="p">.</span><span class="nx">oids</span><span class="p">.</span><span class="nx">sha256</span><span class="p">,</span>
  <span class="na">authenticatedAttributes</span><span class="p">:</span> <span class="p">[{</span>
    <span class="na">type</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pki</span><span class="p">.</span><span class="nx">oids</span><span class="p">.</span><span class="nx">contentType</span><span class="p">,</span>
    <span class="na">value</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pki</span><span class="p">.</span><span class="nx">oids</span><span class="p">.</span><span class="nx">data</span>
  <span class="p">},</span> <span class="p">{</span>
    <span class="na">type</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pki</span><span class="p">.</span><span class="nx">oids</span><span class="p">.</span><span class="nx">messageDigest</span>
    <span class="c1">// value will be auto-populated at signing time</span>
  <span class="p">},</span> <span class="p">{</span>
    <span class="na">type</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pki</span><span class="p">.</span><span class="nx">oids</span><span class="p">.</span><span class="nx">signingTime</span><span class="p">,</span>
    <span class="c1">// value can also be auto-populated at signing time</span>
    <span class="na">value</span><span class="p">:</span> <span class="k">new</span> <span class="nb">Date</span><span class="p">()</span>
  <span class="p">}]</span>
<span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">encryptedPrivateKeyInfo</span> <span class="o">=</span> <span class="nx">pki</span><span class="p">.</span><span class="nx">encryptPrivateKeyInfo</span><span class="p">(</span>
  <span class="nx">privateKeyInfo</span><span class="p">,</span> <span class="s1">'password'</span><span class="p">,</span> <span class="p">{</span>
    <span class="na">algorithm</span><span class="p">:</span> <span class="s1">'aes256'</span><span class="p">,</span> <span class="c1">// 'aes128', 'aes192', 'aes256', '3des'</span>
  <span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">pem</span> <span class="o">=</span> <span class="nx">pki</span><span class="p">.</span><span class="nx">encryptRsaPrivateKey</span><span class="p">(</span><span class="nx">privateKey</span><span class="p">,</span> <span class="s1">'password'</span><span class="p">,</span> <span class="p">{</span><span class="na">legacy</span><span class="p">:</span> <span class="kc">true</span><span class="p">});</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// generate a key pair</span>
...
<span class="nx">csr</span><span class="p">.</span><span class="nx">setAttributes</span><span class="p">([{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'challengePassword'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="s1">'password'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'unstructuredName'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="s1">'My Company, Inc.'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'extensionRequest'</span><span class="p">,</span>
  <span class="na">extensions</span><span class="p">:</span> <span class="p">[{</span>
    ...
    <span class="na">altNames</span><span class="p">:</span> <span class="p">[{</span>
      ...
      <span class="na">value</span><span class="p">:</span> <span class="s1">'test.domain.com'</span>
    <span class="p">},</span> <span class="p">{</span>
      <span class="na">type</span><span class="p">:</span> <span class="mi">2</span><span class="p">,</span>
      <span class="na">value</span><span class="p">:</span> <span class="s1">'other.domain.com'</span><span class="p">,</span>
    <span class="p">},</span> <span class="p">{</span>
      <span class="na">type</span><span class="p">:</span> <span class="mi">2</span><span class="p">,</span>
      <span class="na">value</span><span class="p">:</span> <span class="s1">'www.domain.net'</span>
    <span class="p">}]</span>
  <span class="p">}]</span>
<span class="p">}]);</span>
...
<span class="nx">csr</span><span class="p">.</span><span class="nx">getAttribute</span><span class="p">({</span><span class="na">name</span><span class="p">:</span> <span class="s1">'challengePassword'</span><span class="p">});</span>

<span class="c1">// get extensions array</span>
<span class="nx">csr</span><span class="p">.</span><span class="nx">getAttribute</span><span class="p">({</span><span class="na">name</span><span class="p">:</span> <span class="s1">'extensionRequest'</span><span class="p">}).</span><span class="nx">extensions</span><span class="p">;</span>
...
to <code class="highlighter-rouge">forge.pkcs12.toPkcs12Asn1</code> using the <code class="highlighter-rouge">{algorithm: '3des'}</code> option.</p>

<p><strong>Examples</strong></p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// decode p12 from base64</span>
...
<span class="kd">var</span> <span class="nx">bags</span> <span class="o">=</span> <span class="nx">p12</span><span class="p">.</span><span class="nx">getBags</span><span class="p">({</span><span class="na">friendlyName</span><span class="p">:</span> <span class="s1">'test'</span><span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">bags</span> <span class="o">=</span> <span class="nx">p12</span><span class="p">.</span><span class="nx">getBags</span><span class="p">({</span><span class="na">localKeyId</span><span class="p">:</span> <span class="nx">buffer</span><span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">bags</span> <span class="o">=</span> <span class="nx">p12</span><span class="p">.</span><span class="nx">getBags</span><span class="p">({</span><span class="na">localKeyIdHex</span><span class="p">:</span> <span class="s1">'7b59377ff142d0be4565e9ac3d396c01401cd879'</span><span class="p">});</span>
<span class="c1">// bags are key'd by attribute type (here "localKeyId", *not* "localKeyIdHex")</span>
<span class="c1">// and the key values are an array of matching objects</span>
<span class="kd">var</span> <span class="nx">cert</span> <span class="o">=</span> <span class="nx">bags</span><span class="p">.</span><span class="nx">localKeyId</span><span class="p">[</span><span class="mi">0</span><span class="p">];</span>

<span class="c1">// get bags by type</span>
<span class="kd">var</span> <span class="nx">bags</span> <span class="o">=</span> <span class="nx">p12</span><span class="p">.</span><span class="nx">getBags</span><span class="p">({</span><span class="na">bagType</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pki</span><span class="p">.</span><span class="nx">oids</span><span class="p">.</span><span class="nx">certBag</span><span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">bags</span> <span class="o">=</span> <span class="nx">p12</span><span class="p">.</span><span class="nx">getBags</span><span class="p">({</span>
  <span class="na">friendlyName</span><span class="p">:</span> <span class="s1">'test'</span><span class="p">,</span>
  <span class="na">bagType</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pki</span><span class="p">.</span><span class="nx">oids</span><span class="p">.</span><span class="nx">certBag</span>
<span class="p">});</span>

<span class="c1">// get key bags</span>
<span class="kd">var</span> <span class="nx">bags</span> <span class="o">=</span> <span class="nx">p12</span><span class="p">.</span><span class="nx">getBags</span><span class="p">({</span><span class="na">bagType</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pki</span><span class="p">.</span><span class="nx">oids</span><span class="p">.</span><span class="nx">keyBag</span><span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">p12Asn1</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pkcs12</span><span class="p">.</span><span class="nx">toPkcs12Asn1</span><span class="p">(</span>
  <span class="nx">privateKey</span><span class="p">,</span> <span class="nx">certificateChain</span><span class="p">,</span> <span class="s1">'password'</span><span class="p">,</span>
  <span class="p">{</span><span class="na">algorithm</span><span class="p">:</span> <span class="s1">'3des'</span><span class="p">});</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">asn1</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">asn1</span><span class="p">;</span>
...
<span class="kd">var</span> <span class="nx">publicKeyValidator</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="s1">'SubjectPublicKeyInfo'</span><span class="p">,</span>
  <span class="na">tagClass</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span>
  <span class="na">type</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Type</span><span class="p">.</span><span class="nx">SEQUENCE</span><span class="p">,</span>
  <span class="na">constructed</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
  <span class="na">captureAsn1</span><span class="p">:</span> <span class="s1">'subjectPublicKeyInfo'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="p">[{</span>
    <span class="na">name</span><span class="p">:</span> <span class="s1">'SubjectPublicKeyInfo.AlgorithmIdentifier'</span><span class="p">,</span>
    <span class="na">tagClass</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span>
    <span class="na">type</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Type</span><span class="p">.</span><span class="nx">SEQUENCE</span><span class="p">,</span>
    <span class="na">constructed</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
    <span class="na">value</span><span class="p">:</span> <span class="p">[{</span>
      <span class="na">name</span><span class="p">:</span> <span class="s1">'AlgorithmIdentifier.algorithm'</span><span class="p">,</span>
      <span class="na">tagClass</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span>
      <span class="na">type</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Type</span><span class="p">.</span><span class="nx">OID</span><span class="p">,</span>
      <span class="na">constructed</span><span class="p">:</span> <span class="kc">false</span><span class="p">,</span>
      <span class="na">capture</span><span class="p">:</span> <span class="s1">'publicKeyOid'</span>
    <span class="p">}]</span>
  <span class="p">},</span> <span class="p">{</span>
    <span class="c1">// subjectPublicKey</span>
    <span class="na">name</span><span class="p">:</span> <span class="s1">'SubjectPublicKeyInfo.subjectPublicKey'</span><span class="p">,</span>
    <span class="na">tagClass</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span>
    <span class="na">type</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Type</span><span class="p">.</span><span class="nx">BITSTRING</span><span class="p">,</span>
    <span class="na">constructed</span><span class="p">:</span> <span class="kc">false</span><span class="p">,</span>
    <span class="na">value</span><span class="p">:</span> <span class="p">[{</span>
      <span class="c1">// RSAPublicKey</span>
      <span class="na">name</span><span class="p">:</span> <span class="s1">'SubjectPublicKeyInfo.subjectPublicKey.RSAPublicKey'</span><span class="p">,</span>
      <span class="na">tagClass</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span>
      <span class="na">type</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Type</span><span class="p">.</span><span class="nx">SEQUENCE</span><span class="p">,</span>
      <span class="na">constructed</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
      <span class="na">optional</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
      <span class="na">captureAsn1</span><span class="p">:</span> <span class="s1">'rsaPublicKey'</span>
    <span class="p">}]</span>
  <span class="p">}]</span>
<span class="p">};</span>
...
<h2 id="message-digests-1">Message Digests</h2>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">md</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">md</span><span class="p">.</span><span class="nx">sha1</span><span class="p">.</span><span class="nx">create</span><span class="p">();</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">md</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">md</span><span class="p">.</span><span class="nx">sha256</span><span class="p">.</span><span class="nx">create</span><span class="p">();</span>
<span class="nx">md</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="s1">'The quick brown fox jumps over the lazy dog'</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">md</span><span class="p">.</span><span class="nx">digest</span><span class="p">().</span><span class="nx">toHex</span><span class="p">());</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">md</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">md</span><span class="p">.</span><span class="nx">sha384</span><span class="p">.</span><span class="nx">create</span><span class="p">();</span>
<span class="nx">md</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="s1">'The quick brown fox jumps over the lazy dog'</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">md</span><span class="p">.</span><span class="nx">digest</span><span class="p">().</span><span class="nx">toHex</span><span class="p">());</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// SHA-512</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">md</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">md</span><span class="p">.</span><span class="nx">md5</span><span class="p">.</span><span class="nx">create</span><span class="p">();</span>
<span class="nx">md</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="s1">'The quick brown fox jumps over the lazy dog'</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">md</span><span class="p">.</span><span class="nx">digest</span><span class="p">().</span><span class="nx">toHex</span><span class="p">());</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">hmac</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">hmac</span><span class="p">.</span><span class="nx">create</span><span class="p">();</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// generate a random prime on the main JS thread</span>
...
<span class="kd">var</span> <span class="nx">options</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">algorithm</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">name</span><span class="p">:</span> <span class="s1">'PRIMEINC'</span><span class="p">,</span>
    <span class="na">workers</span><span class="p">:</span> <span class="o">-</span><span class="mi">1</span> <span class="c1">// auto-optimize # of workers</span>
  <span class="p">}</span>
<span class="p">};</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// get some random bytes synchronously</span>
...
<span class="nx">forge</span><span class="p">.</span><span class="nx">random</span><span class="p">.</span><span class="nx">registerWorker</span><span class="p">(</span><span class="nb">self</span><span class="p">);</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// encode/decode base64</span>
...
<p>The <a href="/node_modules/node-forge/flash/">flash README</a> provides details on rebuilding the
