...
<title>Example importer.c | estebang23.github.io</title>
<meta name="generator" content="Jekyll v3.7.3" />
<meta property="og:title" content="Example importer.c" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/node_modules/node-sass/src/libsass/docs/api-importer-example.html" />
<meta property="og:url" content="http://localhost:4000/node_modules/node-sass/src/libsass/docs/api-importer-example.html" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/node-sass/src/libsass/docs/api-importer-example.html","headline":"Example importer.c","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
  ...
  <body>
    <div class="container-lg px-3 my-5 markdown-body">
      ...
      <h2 id="example-importerc">Example importer.c</h2>
...
<p>Compile importer.c</p>

<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code>gcc <span class="nt">-c</span> importer.c <span class="nt">-o</span> importer.o
gcc <span class="nt">-o</span> importer importer.o <span class="nt">-lsass</span>
<span class="nb">echo</span> <span class="s2">"@import 'foobar';"</span> <span class="o">&gt;</span> importer.scss
./importer importer.scss
</code></pre></div></div>

<h2 id="importer-behavior-examples">Importer Behavior Examples</h2>

<pre><code class="language-C">Sass_Import_List importer(const char* path, Sass_Importer_Entry cb, struct Sass_Compiler* comp) {
