...
<link rel="canonical" href="http://localhost:4000/node_modules/node-sass/src/libsass/docs/api-value.html" />
<meta property="og:url" content="http://localhost:4000/node_modules/node-sass/src/libsass/docs/api-value.html" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/node-sass/src/libsass/docs/api-value.html","headline":"estebang23.github.io","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
  ...
  <body>
    <div class="container-lg px-3 my-5 markdown-body">
      ...
      <p><code class="highlighter-rouge">Sass_Values</code> are used to pass values and their types between the implementer
...
have to find a way to <a href="https://en.wikipedia.org/wiki/Marshalling_%28computer_science%29">marshal</a> (convert) <code class="highlighter-rouge">Sass_Values</code> between the target
language and C. <code class="highlighter-rouge">Sass_Values</code> are currently only used by custom functions, but
it should also be possible to use them without a compiler context.</p>

<h3 id="basic-usage">Basic Usage</h3>

<pre><code class="language-C">#include "sass/values.h"
</code></pre>

<pre><code class="language-C">// Type for Sass values
enum Sass_Tag {
  SASS_BOOLEAN,
  SASS_NUMBER,
  SASS_COLOR,
...
<h3 id="sass-value-api">Sass Value API</h3>
...
<ul>
  <li><a href="/node_modules/node-sass/src/libsass/docs/api-value-example.html">Sass Value Example</a></li>
  <li><a href="/node_modules/node-sass/src/libsass/docs/api-value-internal.html">Sass Value Internal</a></li>
</ul>
