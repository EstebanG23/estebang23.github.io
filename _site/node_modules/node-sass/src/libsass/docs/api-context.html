...
<link rel="canonical" href="http://localhost:4000/node_modules/node-sass/src/libsass/docs/api-context.html" />
<meta property="og:url" content="http://localhost:4000/node_modules/node-sass/src/libsass/docs/api-context.html" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/node-sass/src/libsass/docs/api-context.html","headline":"estebang23.github.io","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
  ...
  <body>
    <div class="container-lg px-3 my-5 markdown-body">
      ...
      <p>Sass Contexts come in two flavors:</p>

<ul>
  <li><code class="highlighter-rouge">Sass_File_Context</code></li>
  <li><code class="highlighter-rouge">Sass_Data_Context</code></li>
</ul>
...
<p><strong><em>Sass_Options</em></strong></p>

<pre><code class="language-C">// Precision for fractional numbers
int precision;
</code></pre>
<pre><code class="language-C">// Output style for the generated css code
// A value from above SASS_STYLE_* constants
int output_style;
</code></pre>
<pre><code class="language-C">// Emit comments in the generated CSS indicating
// the corresponding source line.
bool source_comments;
</code></pre>
<pre><code class="language-C">// embed sourceMappingUrl as data uri
bool source_map_embed;
</code></pre>
<pre><code class="language-C">// embed include contents in maps
bool source_map_contents;
</code></pre>
<pre><code class="language-C">// create file urls for sources
bool source_map_file_urls;
</code></pre>
<pre><code class="language-C">// Disable sourceMappingUrl in css output
bool omit_source_map_url;
</code></pre>
<pre><code class="language-C">// Treat source_string as sass (as opposed to scss)
bool is_indented_syntax_src;
</code></pre>
<pre><code class="language-C">// The input path is used for source map
...
<pre><code class="language-C">// The output path is used for source map
// generating. LibSass will not write to
// this file, it is just used to create
// information in source-maps etc.
char* output_path;
</code></pre>
<pre><code class="language-C">// String to be used for indentation
const char* indent;
</code></pre>
<pre><code class="language-C">// String to be used to for line feeds
const char* linefeed;
</code></pre>
<pre><code class="language-C">// Colon-separated list of paths
// Semicolon-separated on Windows
char* include_path;
char* plugin_path;
</code></pre>
<pre><code class="language-C">// Additional include paths
// Must be null delimited
char** include_paths;
char** plugin_paths;
</code></pre>
<pre><code class="language-C">// Path to source map file
// Enables the source map generating
// Used to create sourceMappingUrl
char* source_map_file;
</code></pre>
<pre><code class="language-C">// Directly inserted in source maps
char* source_map_root;
</code></pre>
<pre><code class="language-C">// Custom functions that can be called from Sass code
Sass_C_Function_List c_functions;
</code></pre>
<pre><code class="language-C">// Callback to overload imports
Sass_C_Import_Callback importer;
</code></pre>

<p><strong><em>Sass_Context</em></strong></p>

<pre><code class="language-C">// store context type info
enum Sass_Input_Style type;
</code></pre>
<pre><code class="language-C">// generated output data
char* output_string;
</code></pre>
<pre><code class="language-C">// generated source map json
char* source_map_string;
</code></pre>
<pre><code class="language-C">// error status
int error_status;
char* error_json;
char* error_text;
char* error_message;
...
<pre><code class="language-C">// report imported files
char** included_files;
</code></pre>

<p><strong><em>Sass_File_Context</em></strong></p>

<pre><code class="language-C">// no additional fields required
// input_path is already on options
</code></pre>

<p><strong><em>Sass_Data_Context</em></strong></p>

<pre><code class="language-C">// provided source string
char* source_string;
</code></pre>

<h3 id="sass-context-api">Sass Context API</h3>
...
<h3 id="sass-options-api">Sass Options API</h3>

<pre><code class="language-C">// Getters for Context_Option values
...
<ul>
  <li><a href="/node_modules/node-sass/src/libsass/docs/api-context-example.html">Sass Context Example</a></li>
  <li><a href="/node_modules/node-sass/src/libsass/docs/api-context-internal.html">Sass Context Internal</a></li>
</ul>
