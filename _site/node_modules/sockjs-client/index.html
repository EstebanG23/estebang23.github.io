...
<title>SockJS-client | estebang23.github.io</title>
<meta name="generator" content="Jekyll v3.7.3" />
<meta property="og:title" content="SockJS-client" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/node_modules/sockjs-client/" />
<meta property="og:url" content="http://localhost:4000/node_modules/sockjs-client/" />
<meta property="og:site_name" content="estebang23.github.io" />
<script type="application/ld+json">
{"@type":"WebPage","url":"http://localhost:4000/node_modules/sockjs-client/","headline":"SockJS-client","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<h1 id="sockjs-client">SockJS-client</h1>
...
<ul>
  ...
  <li><a href="https://projects.spring.io/spring-framework">Spring Framework</a> Java <a href="https://docs.spring.io/spring-framework/docs/current/spring-framework-reference/html/websocket.html#websocket-fallback-sockjs-client">client</a> &amp; server</li>
...
but instead of <code class="highlighter-rouge">WebSocket</code> there is a <code class="highlighter-rouge">SockJS</code> Javascript object.</p>

<p>First, you need to load the SockJS JavaScript library. For example, you can
put that in your HTML head:</p>

<div class="language-html highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"https://cdn.jsdelivr.net/sockjs/1/sockjs.min.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre></div></div>

<p>After the script is loaded you can establish a connection with the
SockJS server. Here’s a simple example:</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code> <span class="kd">var</span> <span class="nx">sock</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">SockJS</span><span class="p">(</span><span class="s1">'https://mydomain.com/my_prefix'</span><span class="p">);</span>
 ...
 <span class="nx">sock</span><span class="p">.</span><span class="nx">onmessage</span> <span class="o">=</span> <span class="kd">function</span><span class="p">(</span><span class="nx">e</span><span class="p">)</span> <span class="p">{</span>
     <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">'message'</span><span class="p">,</span> <span class="nx">e</span><span class="p">.</span><span class="nx">data</span><span class="p">);</span>
 <span class="p">};</span>
 ...
 <span class="nx">sock</span><span class="p">.</span><span class="nx">send</span><span class="p">(</span><span class="s1">'test'</span><span class="p">);</span>
 <span class="nx">sock</span><span class="p">.</span><span class="nx">close</span><span class="p">();</span>
</code></pre></div></div>

<h2 id="sockjs-client-api">SockJS-client API</h2>

<h3 id="sockjs-class">SockJS class</h3>

<p>Similar to the ‘WebSocket’ API, the ‘SockJS’ constructor takes one, or more arguments:</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">sockjs</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">SockJS</span><span class="p">(</span><span class="nx">url</span><span class="p">,</span> <span class="nx">_reserved</span><span class="p">,</span> <span class="nx">options</span><span class="p">);</span>
</code></pre></div></div>

<p><code class="highlighter-rouge">url</code> may contain a query string, if one is desired.</p>

<p>Where <code class="highlighter-rouge">options</code> is a hash which can contain:</p>

<ul>
  <li>
    <p><strong>server (string)</strong></p>

    <p>String to append to url for actual data connection. Defaults to a random 4 digit number.</p>
  </li>
  <li>
    <p><strong>transports (string OR array of strings)</strong></p>
...
SockJS. By default all available transports will be used.</p>
  </li>
  <li>
    <p><strong>sessionId (number OR function)</strong></p>
...
string generator to generate 8-character long session ids.</p>
  </li>
</ul>
...
<h2 id="supported-transports-by-browser-html-served-from-http-or-https">Supported transports, by browser (html served from http:// or https://)</h2>
...
<ul>
  <li>
    <p><strong>†</strong>: IE 8+ supports [XDomainRequest]<sup id="fnref:9"><a href="#fn:9" class="footnote">1</a></sup>, which is
 ...
 JSESSIONID cookie to do sticky sessions.</p>
  </li>
  <li>
    <p><strong>‡</strong>: Firefox 4.0 and Opera 11.00 and shipped with disabled
  Websockets “hixie-76”. They can still be enabled by manually
  changing a browser setting.</p>
  </li>
</ul>

<h2 id="supported-transports-by-browser-html-served-from-file">Supported transports, by browser (html served from file://)</h2>
...
<h2 id="supported-transports-by-name">Supported transports, by name</h2>

<table>
  <thead>
    <tr>
      <th><em>Transport</em></th>
  ...
  <tbody>
    <tr>
      ...
      <td>[rfc 6455]<sup id="fnref:10"><a href="#fn:10" class="footnote">2</a></sup></td>
    </tr>
    <tr>
      <td>websocket (hixie-76)</td>
      <td>[draft-hixie-thewebsocketprotocol-76]<sup id="fnref:1"><a href="#fn:1" class="footnote">3</a></sup></td>
    </tr>
    <tr>
      <td>websocket (hybi-10)</td>
      <td>[draft-ietf-hybi-thewebsocketprotocol-10]<sup id="fnref:2"><a href="#fn:2" class="footnote">4</a></sup></td>
    </tr>
    <tr>
      <td>xhr-streaming</td>
      <td>Transport using [Cross domain XHR]<sup id="fnref:5"><a href="#fn:5" class="footnote">5</a></sup> [streaming]<sup id="fnref:7"><a href="#fn:7" class="footnote">6</a></sup> capability (readyState=3).</td>
    </tr>
    <tr>
      <td>xdr-streaming</td>
      <td>Transport using [XDomainRequest]<sup id="fnref:9:1"><a href="#fn:9" class="footnote">1</a></sup> [streaming]<sup id="fnref:7:1"><a href="#fn:7" class="footnote">6</a></sup> capability (readyState=3).</td>
    </tr>
    <tr>
      <td>eventsource</td>
      <td>[EventSource/Server-sent events]<sup id="fnref:4"><a href="#fn:4" class="footnote">7</a></sup>.</td>
    </tr>
    <tr>
      <td>iframe-eventsource</td>
      <td>[EventSource/Server-sent events]<sup id="fnref:4:1"><a href="#fn:4" class="footnote">7</a></sup> used from an [iframe via postMessage]<sup id="fnref:3"><a href="#fn:3" class="footnote">8</a></sup>.</td>
    </tr>
    <tr>
      <td>htmlfile</td>
      <td>[HtmlFile]<sup id="fnref:8"><a href="#fn:8" class="footnote">9</a></sup>.</td>
    </tr>
    <tr>
      <td>iframe-htmlfile</td>
      <td>[HtmlFile]<sup id="fnref:8:1"><a href="#fn:8" class="footnote">9</a></sup> used from an [iframe via postMessage]<sup id="fnref:3:1"><a href="#fn:3" class="footnote">8</a></sup>.</td>
    </tr>
    <tr>
      <td>xhr-polling</td>
      <td>Long-polling using [cross domain XHR]<sup id="fnref:5:1"><a href="#fn:5" class="footnote">5</a></sup>.</td>
    </tr>
    <tr>
      <td>xdr-polling</td>
      <td>Long-polling using [XDomainRequest]<sup id="fnref:9:2"><a href="#fn:9" class="footnote">1</a></sup>.</td>
    </tr>
    <tr>
      <td>iframe-xhr-polling</td>
      <td>Long-polling using normal AJAX from an [iframe via postMessage]<sup id="fnref:3:2"><a href="#fn:3" class="footnote">8</a></sup>.</td>
    </tr>
    <tr>
      <td>jsonp-polling</td>
      <td>Slow and old fashioned [JSONP polling]<sup id="fnref:6"><a href="#fn:6" class="footnote">10</a></sup>. This transport will show “busy indicator” (aka: “spinning wheel”) when sending data.</td>
    </tr>
  </tbody>
</table>

<h2 id="connecting-to-sockjs-without-the-client">Connecting to SockJS without the client</h2>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>gulp browserify
</code></pre></div></div>

<p>To generate minified JavaScript, run:</p>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>gulp browserify:min
</code></pre></div></div>

<p>Both commands output into the <code class="highlighter-rouge">build</code> directory.</p>
...
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm run test:browser_local
</code></pre></div></div>
...
<h2 id="browser-quirks">Browser Quirks</h2>
...
and discussion see <a href="https://github.com/sockjs/sockjs-client/issues/18">#18</a>.</li>
  <li><code class="highlighter-rouge">jsonp-polling</code> transport will show a “spinning wheel” (aka. “busy indicator”)
...
that have proper Unicode support.</li>
  <li>Having a global function called <code class="highlighter-rouge">onmessage</code> or such is probably a
bad idea, as it could be called by the built-in <code class="highlighter-rouge">postMessage</code> API.</li>
...
<div class="footnotes">
  <ol>
    <li id="fn:9">
      <p>https://blogs.msdn.microsoft.com/ieinternals/2010/05/13/xdomainrequest-restrictions-limitations-and-workarounds/ <a href="#fnref:9" class="reversefootnote">&#8617;</a> <a href="#fnref:9:1" class="reversefootnote">&#8617;<sup>2</sup></a> <a href="#fnref:9:2" class="reversefootnote">&#8617;<sup>3</sup></a></p>
    </li>
    <li id="fn:10">
      <p>https://www.rfc-editor.org/rfc/rfc6455.txt <a href="#fnref:10" class="reversefootnote">&#8617;</a></p>
    </li>
    <li id="fn:1">
      <p>https://tools.ietf.org/html/draft-hixie-thewebsocketprotocol-76 <a href="#fnref:1" class="reversefootnote">&#8617;</a></p>
    </li>
    <li id="fn:2">
      <p>https://tools.ietf.org/html/draft-ietf-hybi-thewebsocketprotocol-10 <a href="#fnref:2" class="reversefootnote">&#8617;</a></p>
    </li>
    <li id="fn:5">
      <p>https://secure.wikimedia.org/wikipedia/en/wiki/XMLHttpRequest#Cross-domain_requests <a href="#fnref:5" class="reversefootnote">&#8617;</a> <a href="#fnref:5:1" class="reversefootnote">&#8617;<sup>2</sup></a></p>
    </li>
    <li id="fn:7">
      <p>http://www.debugtheweb.com/test/teststreaming.aspx <a href="#fnref:7" class="reversefootnote">&#8617;</a> <a href="#fnref:7:1" class="reversefootnote">&#8617;<sup>2</sup></a></p>
    </li>
    <li id="fn:4">
      <p>https://html.spec.whatwg.org/multipage/comms.html#server-sent-events <a href="#fnref:4" class="reversefootnote">&#8617;</a> <a href="#fnref:4:1" class="reversefootnote">&#8617;<sup>2</sup></a></p>
    </li>
    <li id="fn:3">
      <p>https://developer.mozilla.org/en/DOM/window.postMessage <a href="#fnref:3" class="reversefootnote">&#8617;</a> <a href="#fnref:3:1" class="reversefootnote">&#8617;<sup>2</sup></a> <a href="#fnref:3:2" class="reversefootnote">&#8617;<sup>3</sup></a></p>
    </li>
    <li id="fn:8">
      <p>http://cometdaily.com/2007/11/18/ie-activexhtmlfile-transport-part-ii/ <a href="#fnref:8" class="reversefootnote">&#8617;</a> <a href="#fnref:8:1" class="reversefootnote">&#8617;<sup>2</sup></a></p>
    </li>
    <li id="fn:6">
      <p>https://secure.wikimedia.org/wikipedia/en/wiki/JSONP <a href="#fnref:6" class="reversefootnote">&#8617;</a></p>
    </li>
  </ol>
</div>
